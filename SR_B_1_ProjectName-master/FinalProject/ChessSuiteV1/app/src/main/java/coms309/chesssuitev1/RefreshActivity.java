 ...
 *
 * This activity is used to refresh the MainActivity GUI.
 */
public class RefreshActivity extends AppCompatActivity {
    ...
    /**
     * Called when this activity is started - it refreshes information from the server and recreates the MainActivity.
