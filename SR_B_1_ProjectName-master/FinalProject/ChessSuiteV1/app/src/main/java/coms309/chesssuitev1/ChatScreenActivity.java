...
public class ChatScreenActivity extends AppCompatActivity {
    ...
    /**
     * When the activity loads to the foreground, grab an update the from the server
     */
    @Override
    ...
    /**
     * Draws the message history to the screen
     * @param messageHistory The message log
     */
