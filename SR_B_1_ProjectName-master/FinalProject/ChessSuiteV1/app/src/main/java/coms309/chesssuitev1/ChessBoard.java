...
public class ChessBoard {
    ...
    private ArrayList<ChessSquare> lastMove;
    ...
    /**
     * Sets the value of the lastMove list to the given list.
     * @param list - the list of square involved in the last move
     */
    public void setLastMove(ArrayList<ChessSquare> list) {
        lastMove = list;
    }

    /**
     * Gets the list of ChessSquare involved in the last move - can be used to highlight the latest move
     * @return - the ArrayList of ChessSquares involved in the latest move (if there is one - otherwise null)
     */
    public ArrayList<ChessSquare> getLastMove() {
        return lastMove;
    }
